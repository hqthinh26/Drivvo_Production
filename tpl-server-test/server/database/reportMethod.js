...
const napNLMethod = require('./napNLMethod');
//const napNLMethod = require('./napNLMethod');
...
const entryDay_and_currentDay = async (usr_id) => {
    ...
    return {start_date_general, current_date_general, date_diff_general};
};
...
module.exports = {
    ...
    report_NLL: async (usr_id) => {
        try {
            ...
            const {start_date_general, current_date_general, date_diff_general} = await entryDay_and_currentDay(usr_id); //entry & date_diff
           ...
           const related_values_nll = await napNLMethod._startDay_and_currentDay_refilling_time_precision(usr_id);
            ...
            return {
                    Entry: {start_date_general, current_date_general, date_diff_general},
                    related_values_nll,
